...
IF OBJECT_ID('App_Supplier_GetAllSuppliers', 'P') IS NULL
BEGIN
	EXEC ('CREATE PROC App_Supplier_GetAllSuppliers as select ''x''');
END;
GO
...
-- =============================================
ALTER PROCEDURE App_Supplier_GetAllSuppliers
AS
BEGIN
